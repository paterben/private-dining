...
public class ReservationServiceImplTest {
    ...
    void testListReservationsForRestaurantAndTable() {
        // Arrange
        Reservation foundReservation1 = new Reservation("5678", "1234", "2345", "3456", "reservation1",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundReservation2 = new Reservation("6789", "1234", "2345", "4567", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
        TableReservations foundTableReservations = new TableReservations("2345", "1234",
    ...
    void testListReservationsForRestaurantAndTableRestaurantMismatch() {
        // Arrange
        Reservation foundReservation1 = new Reservation("5678", "9999", "2345", "3456", "reservation1",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundReservation2 = new Reservation("6789", "9999", "2345", "4567", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
        TableReservations foundTableReservations = new TableReservations("2345", "9999",
                Arrays.asList(foundReservation1, foundReservation2));
        when(tableReservationsRepository.findById("2345")).thenReturn(Optional.of(foundTableReservations));
    ...
    void testListReservationsForDiner() {
        // Arrange
        Reservation foundReservation1 = new Reservation("6789", "1234", "2345", "5678", "reservation1",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundReservation2 = new Reservation("7890", "3456", "4567", "5678", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
    ...
    void testGetReservationForDinerByIdReservationNotFound() {
        ...
        Reservation foundReservation1 = new Reservation("6789", "1234", "2345", "5678", "reservation1",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundReservation2 = new Reservation("8901", "3456", "4567", "5678", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
        DinerReservations foundDinerReservations = new DinerReservations("5678",
                Arrays.asList(foundReservation1, foundReservation2));
        when(dinerReservationsRepository.findById("5678")).thenReturn(Optional.of(foundDinerReservations));
    ...
    void testGetReservationForRestaurantAndTableByIdReservationNotFound() {
        ...
        Reservation foundReservation1 = new Reservation("5678", "1234", "2345", "3456", "reservation1",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundReservation2 = new Reservation("7890", "1234", "2345", "4567", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
        TableReservations foundTableReservations = new TableReservations("2345", "1234",
                Arrays.asList(foundReservation1, foundReservation2));
        when(tableReservationsRepository.findById("2345")).thenReturn(Optional.of(foundTableReservations));
    ...
    void testCreateReservationForRestaurantAndTable() {
        ...
        Reservation foundDinerReservation1 = new Reservation("4333", "1222", "2333", "3222", "reservation3",
                Instant.ofEpochSecond(11111), Instant.ofEpochSecond(22222), Instant.ofEpochSecond(1234));
        Reservation foundDinerReservation2 = new Reservation("4222", "1111", "2222", "3222", "reservation2",
                Instant.ofEpochSecond(22222), Instant.ofEpochSecond(33333), Instant.ofEpochSecond(2345));
    ...
    void testCreateReservationForRestaurantAndTableWithoutDinerIdFailsWithBadRequest() {
        // Act
        Reservation reservation = new Reservation("", "reservation4", Instant.ofEpochSecond(33333),
                Instant.ofEpochSecond(44444));
        try {
            reservationService.createReservationForRestaurantAndTable("1111", "2222", reservation);
            fail();
    ...
    void testCreateReservationForRestaurantAndTableWithoutNameIdFailsWithBadRequest() {
        // Act
        Reservation reservation = new Reservation("3222", "", Instant.ofEpochSecond(33333),
                Instant.ofEpochSecond(44444));
        try {
            reservationService.createReservationForRestaurantAndTable("1111", "2222", reservation);
            fail();
    ...
    void testCreateReservationForRestaurantAndTableWithoutReservationStartFailsWithBadRequest() {
        // Act
        Reservation reservation = new Reservation("3222", "reservation4", null, Instant.ofEpochSecond(44444));
        try {
            reservationService.createReservationForRestaurantAndTable("1111", "2222", reservation);
            fail();
        } catch (ServiceException e) {
    ...
    void testCreateReservationForRestaurantAndTableWithoutReservationEndFailsWithBadRequest() {
        // Act
        Reservation reservation = new Reservation("3222", "reservation4", Instant.ofEpochSecond(33333), null);
        try {
            reservationService.createReservationForRestaurantAndTable("1111", "2222", reservation);
            fail();
        } catch (ServiceException e) {
